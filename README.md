# solitaire-player
Solve and automatically play Pyramid or TriPeaks Solitaire.  Watch the [demonstration video for getting started and solving TriPeaks Solitaire](https://youtu.be/15EBJO5PNnU), or the [demonstration video for Pyramid Solitaire](https://youtu.be/2fs49YDfUR4).  The latest release for Windows 10 for download is [version 2.6.9](https://github.com/mchung94/solitaire-player/releases/download/v2.6.8/solitaire-player-v2.6.9.zip).  This requires that you install a [64 bit JRE 11](https://adoptium.net/) first.
